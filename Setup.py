...
def addData(choice):
    ...
    imageData["iconpack"] = input("iconpack : ")
    imageData["image"] = input("wallpaper app name : ")
    imageData["launcher"] = input("launcher : ")
    imageData["authorLink"] = input("authorLink : ")
    imageData["kwgtLink"] = input("kwgtLink : ")
    imageData["iconpackLink"] = input("iconpackLink : ")
    imageData["imageLink"] = input("wallpaper app link : ")
